function getLinks() {
  ...
  links.statusDocId = "1Quw84JlZV5Ym7wzXC0YOPkpXL6IXOKMbanEX_ZtyHaY";
...
function sendDraftEmails() {
  ...
  drafts.forEach(draft => {
    ...
    console.log("Sending draft with subject [%s] addressed to %s", message.getSubject(), message.getTo());
    draft.send();
  });
  return count;
}
